...
if ($_FILES['InputFile']['name']=='') //se l'utente non inserisce il file
 {
   header("location: index.html"); //redirect alla homepage
 }
...
<div class="container-fluid">
  ...
  <img src="imgs/LSLogo.png" width="50" height="50" class="d-inline-block align-top" alt="logo">
...
<div class="col-sm">
  ...
  <?php webCallAnalysis($file_name); ?>
  <div class="card-header"><h6> IP Rilevati </h6></div>
  <?php ipAnalysis($file_name);?>
  </div>
</div>
...
<div class="row">
  ...
  <div class="col-sm">
    ...
    <div class="card border-dark mb-3" style="width: 25rem;">
    <h3 class="card-title" align="center">Modifiche al sistema</h3>
    <img class="card-img-top" src="imgs/registry.png" alt="web" height="370" >
    <div class="card-body">

    <p class="card-text" align="center">I risultati del controllo su registri e variabili di sistema.</p>
    </div>
    <div class="card-header"><h6> Rilevamenti su registri</h6></div>
    <?php regAnalysis($file_name); ?>
    <div class="card-header"><h6> Rilevamenti su variabili</h6></div>
    <?php varAnalysis($file_name);?>
    </div>
  </div>
  ...
  <div class="col-sm">
    ...
    <div class="card border-dark mb-3" style="width: 25rem;">
    <h3 class="card-title" align="center">Keywords ed autodefinizione</h3>
    <img class="card-img-top" src="imgs/keywords.png" alt="web" height="370" >
    <div class="card-body">

    <p class="card-text" align="center">I risultati del controllo su parole chiave che potrebbero identificare un malware.</p>
    </div>
    <div class="card-header"><h6> Rilevamenti keywords</h6></div>
    <?php wordAnalysis($file_name);?>
    </div>
  </div>
