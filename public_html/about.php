...
<div class="row">
  <div class="col-md">
    ...
    <p align="center"> Appassionato di informatica, maturando nel 2018, frequento la classe 5°AINF dell'Istituto ITTS A.Volta di Perugia.
        Tra le mie passioni ci sono la musica, in particolare rock e sperimentale, la chitarra, il cinema e le arti visive.
        Ho realizzato in passato alcuni videogiochi e alcuni piccoli software, sto studiando
        e spero di studiare ed apprendere ancora molto sul mondo dell'informatica.
  ...
  <div class="col-md">
      ...
      <img class="card-img-top" src="imgs/LSLogo.png" alt="author">
      <div class="card-body">
  ...
  <div class="col-md">
    ...
    <p align="center"> Vorrei ringraziare la prof.ssa <a href="https://github.com/mciuchetti">Monica Ciuchetti</a> per il supporto tecnico e morale nella realizzazione
      del progetto, i miei compagni di classe e amici che vedete nella foto per il supporto
      morale durante lo sviluppo, la mia famiglia perché lo fanno tutti gli sviluppatori di software e suona bene, l'ex collega di studi Nicolò Vescera per l'aiuto
      nella realizzazione del percorso, e infine me stesso.
